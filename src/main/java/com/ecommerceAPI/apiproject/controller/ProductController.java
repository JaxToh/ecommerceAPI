...
@RequestMapping("/products") /*
                              * annotation to map HTTP requests to handler methods in Spring MVC controllers.
                              */
@AllArgsConstructor
...
public class ProductController {
    ...
    // allProduct.add(new Product("iPhone 14", "smartphones", "An apple mobile which
    // is nothing like apple", null, 1299.10));
    // allProduct.add(new Product("iPhone 15", "smartphones", "An apple mobile A16
    // Bionic powers all kinds of advanced features.", null, 1499.10));
    // allProduct.add(new Product("iPhone 15 pro", "smartphones", "An apple mobile
    // only for the professionals ", null, 1699.10));
    // }
