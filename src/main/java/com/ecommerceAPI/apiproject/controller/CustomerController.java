...
import com.ecommerceAPI.apiproject.service.CustomerService;
...
public class CustomerController {
    ...
    // return new ResponseEntity<>(customerService.addInteractionToCustomer(id,
    // interaction), HttpStatus.CREATED);
    // }
